            ...
            <div className="text-center h-full flex flex-col items-center justify-center">
              ...
              {isTrainingAdmin && (
                <Link
                  ...
                  className="mt-4 inline-flex justify-center rounded-md bg-secondary-600 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-secondary-500 focus-visible:outline focus-visible:outline-offset-2 focus-visible:outline-secondary-600"
                >
