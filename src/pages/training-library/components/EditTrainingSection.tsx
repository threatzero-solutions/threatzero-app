                ...
                <div className="mt-3 flex sm:ml-4 sm:mt-0">
                  {itemFields.length > 0 && (
                    <button
                      ...
                      className="ml-3 inline-flex items-center rounded-md bg-primary-600 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-primary-500 focus-visible:outline focus-visible:outline-offset-2 focus-visible:outline-primary-600"
                    >
                      + Add Items
                    </button>
                  )}
