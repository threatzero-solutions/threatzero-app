            ...
            <div className="mt-3 flex sm:ml-4 sm:mt-0">
              ...
              {courseData?.sections && courseData?.sections.length > 0 && (
                <button
                  ...
                  disabled={isNew}
                  className="ml-3 inline-flex items-center rounded-md bg-primary-600 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-primary-500 focus-visible:outline focus-visible:outline-offset-2 focus-visible:outline-primary-600 disabled:opacity-50"
                >
                  + New Section
                </button>
              )}
