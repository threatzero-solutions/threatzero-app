    ...
    <div className="md:mx-0 -mx-4 md:w-full w-screen">
      ...
      >
        <a
          ...
          className="inline-flex items-center gap-x-2 rounded-md bg-primary-600 cursor-pointer px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-primary-500 focus-visible:outline focus-visible:outline-offset-2 focus-visible:outline-primary-600"
        >
