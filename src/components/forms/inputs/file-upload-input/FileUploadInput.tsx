  ...
  return (
    ...
    >
      ...
      {!!files.length && (
        ...
        >
          {!readOnly && (
            <div className="cursor-pointer rounded-full bg-primary-600 p-1.5 text-white shadow-xs hover:bg-primary-500 focus-visible:outline focus-visible:outline-offset-2 focus-visible:outline-primary-600">
