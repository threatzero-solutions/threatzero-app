        ...
        <div className="flex items-center justify-between gap-4 pt-1">
          ...
          <div className="flex gap-2">
            ...
            <button
              type="submit"
              disabled={submitting}
              className="rounded-md bg-primary-600 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-primary-500 focus-visible:outline focus-visible:outline-offset-2 focus-visible:outline-primary-600 disabled:opacity-60"
            >
              {submitting
                ? "Saving…"
                : initial
