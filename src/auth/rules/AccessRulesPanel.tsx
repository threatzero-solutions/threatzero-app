  ...
  return (
    <div className="rounded-lg bg-white ring-1 ring-gray-900/5 p-6">
      ...
      <button
        type="button"
        onClick={onCreate}
        className="mt-5 rounded-md bg-secondary-600 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-secondary-500 focus-visible:outline focus-visible:outline-offset-2 focus-visible:outline-secondary-600"
      >
